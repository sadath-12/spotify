...
<Dropdown/>
    ...
    <div className="bg-[#00D0D0D] border-2 border-[#262626] p-4 rounded-xl w-[250px] space-y-4">
...
{recentlyPlayed.map((track,index)=>(
  ...
  />
    ...
    <button className="text-[#CECECE] bg-[#1A1A1A] text-[13px] py-3.5 px-4 rounded-2xl w-full font-bold bg-opacity-80 hover:bg-opacity-100 transition ease-out">View All</button>
