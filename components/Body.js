...
console.log(searchResults)
  ...
  return (
    ...
    md:max-w-6xl flex-grow md:mr-2.5'>
      
<Search search={search}  setSearch={setSearch}/>
<div className='grid overflow-y-scroll scrollbar-hide h-96 grid-cols-2
 lg:grid-cols-3 xl:grid-cols-4 space-x-4 gap-y-8  p-4'>
...
<div className="flex gap-x-2 gap-y-2.5 flex-wrap mb-3">
          ...
          <button className="text-[#CECECE] bg-[#1A1A1A] text-[13px] py-3.5 px-4 rounded-2xl w-full font-bold bg-opacity-80 hover:bg-opacity-100 transition ease-out">All Genres</button>
